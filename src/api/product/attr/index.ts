...
) => requset.get<any, AttrResponseData>(API.ATTR_URL + `${category1Id}/${category2Id}/${category3Id}`)
// 添加/修改属性
export const reqAddOrEditAttr = (data: AttrList) => requset.post<any, any>(API.ADDOREDITATTR_URL, data)
// 删除属性
export const reqRemoveAttr = (attrId: number) => requset.delete<any, any>(API.REMOVEATTR_URL+attrId)
